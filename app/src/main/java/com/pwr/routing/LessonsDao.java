...
public class LessonsDao {
    ...
    public String getParzystosc() {
        return parzystosc;
    }

    public void setParzystosc(String parzystosc) {
    ...
    public LessonsDao[] getResponse() {
        return response;
    }

    public void setResponse(LessonsDao[] response) {
